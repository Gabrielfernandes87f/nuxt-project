  ...
  <div class="py-12 bg-orange-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center text-center sm:text-center">
        ...
        <p
          class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 md:text-center sm:text-center"
        >Gabriel Fernandes</p>
        <p
          class="mt-4 leading-8 font-extrabold tracking-tight text-gray-500 md:text-center sm:text-center"
        >Desenvolvedor fullstack/DevOps jr - Laravel</p>
      </div>

      <div class="overflow-hidden shadow-lg">
        <div class="px-6 py-4">
          <div class="font-bold text-xl mb-2">Sobre mim</div>
          <p class="text-gray-700 text-base">
            Desenvolvedor fullStack/DevOps
            com mais de 2 ano de experiência.
            Desenvolvimento de sistemas web, integração de sistemas.
            Deploy de sistemas e web sites
            Estudando e aprendendo novas tecnologias e ferramentas, todos os dias.
            Foco em desenvolvimento de aplicação Laravel e Nuxt JS.
          </p>
        </div>
        <div class="px-6 py-4">
          <div class="font-bold text-xl mb-2">Experiência</div>
          <p
        ...
        <div class="px-6 py-4">
          <div class="font-bold text-xl mb-2">Formação</div>
          <p
            class="text-gray-700 text-base"
